...
<title>updatapushwithtype</title>
<link rel="stylesheet"
	href="https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css">
</head>
<body>

	<form class="form-horizontal" action="updatapushwithtype" method="post">
		<!-- 水平表单 -->
		...
		<input type="hidden" value="${push.ID}" id="ID" name="ID">
			...
			<div class="col-sm-6">
				...
				<input type="text" class="form-control" id="title" placeholder="标题"
					name="title" value="${push.page.title}" disabled="">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<!-- 改变查询框的长度 -->
				<a href="resultpage?ID=${push.page.ID}">${push.page.link}</a>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<input type="text" class="form-control" id="source" placeholder="标题"
					name="source" value="${push.page.source}" disabled="">
			</div>
		</div>
		<div class="form-group">
