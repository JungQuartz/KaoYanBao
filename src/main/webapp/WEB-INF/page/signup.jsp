		...
		<div class="cgs">
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-7">
				<div class="user-div">
					<h1>用户注册</h1>
					<ul>
						<li><i>&#x2656;</i><input type="text" id="account"
							name="account" value="" placeholder="请输入账号" /></li>
						<li><i>&#xe680;</i><input type="password" id="password"
							name="password" value="" placeholder="请输入密码" /></li>
						<li><i>&#xe680;</i><input type="password" id="password_again"
							name="password_again" value="" placeholder="请输入确认密码" /></li>
						<li><i>&#xe6ed;</i><input type="text" id="phone" name="phone"
							value="" placeholder="请输入电话" /></li>
						<li><i>&#xe681;</i><input type="text" id="email" name="email"
							value="" placeholder="请输入邮箱" /></li>
					</ul>
