...
<body>
	<div class="main-content">
		<form class="form-horizontal" action="addadmin" method="post">
			...
			<div class="form-group">
				<label for="inputText" class="col-sm-2 control-label">再次输入密码</label>
				<div class="col-sm-4">
					<input type="password" class="form-control" id="password_again" name="password_again" placeholder="再次输入密码">
				</div>
			</div>
				<div class="form-group">
